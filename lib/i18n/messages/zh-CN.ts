...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "common.plugins": "插件",
    "common.settings": "设置",
    "updates.available": "有可用的 momp 更新",
    "updates.availableTitle": "momp {version} 可用",
    "updates.dialogEyebrow": "momp 发布",
    "updates.dialogTitle": "新的 momp 版本",
    "updates.current": "已安装 momp {version}",
    ...
    "sidebar.deleteProjectFromDisk": "从磁盘永久删除项目文件夹",
    "sidebar.deleteProjectFromDiskTitle": "从电脑中彻底删除项目文件夹及其所有文件",
    "sidebar.deleteProjectConfirm": "确定要彻底删除文件夹 {path} 及其所有文件吗？",
    "sidebar.deleteProjectConfirmBtn": "永久删除",
    ...
    "directoryPicker.newFolderName": "新文件夹名称",
    ...
    "chat.allModels": "全部模型",
    "roles.title": "模型角色",
    "roles.description": "omp 按角色分派任务，而非只用一个当前模型。为每个角色分配模型后，momp-web 与 omp 命令行都会使用该配置。",
    "roles.scope": "保存到",
    ...
    "chat.voiceListening": "正在录音... 点击停止",
    "chat.voiceNotSupported": "当前浏览器不支持语音识别",
    "chat.voiceError": "语音输入错误",
    "chat.voiceNetworkError": "当前浏览器无法连接语音识别云端服务。建议使用 Google Chrome 或 Microsoft Edge 进行语音输入。",
    "chat.voicePermissionError": "麦克风权限被拒绝。请在浏览器设置中允许麦克风权限。",
    "chat.voiceNoSpeech": "未检测到语音。请重新说话。",
    "chat.commandRefactor": "代码重构",
    "chat.commandTests": "编写单元测试",
    "chat.commandReview": "代码审查",
    "chat.commandFix": "修复错误",
    "chat.commandExplain": "解释代码",
    "chat.commandDoc": "编写文档",
    "files.editMode": "编辑",
    "files.save": "保存 (Ctrl+S)",
    "files.saving": "正在保存...",
    "files.saved": "已保存",
    "files.saveError": "保存文件失败",
    "files.unsavedChanges": "未保存的更改",
    "files.confirmDiscard": "您有未保存的更改。确定要放弃吗？",
    "models.localDiscoveryTitle": "本地模型 (Ollama, LM Studio)",
    "models.localDiscoveryScan": "🔍 扫描本地模型",
    "models.localDiscoveryScanning": "正在扫描本地服务...",
    "models.localDiscoveryFound": "发现：{services}",
    "models.localDiscoveryNotFound": "未发现运行中的 Ollama 或 LM Studio",
    "models.localDiscoveryAdd": "连接 {name}（{count} 个模型）",
    "models.localDiscoveryAdded": "已成功添加 {name} 提供商！",
    "settings.notifications": "浏览器通知",
    "settings.notificationsDesc": "当智能体在后台标签页完成回复时发送系统通知。",
    "settings.notificationsEnable": "启用通知",
    "settings.notificationsEnabled": "通知已启用",
    "settings.notificationsPermissionDenied": "浏览器设置中已屏蔽通知权限",
    "tabs.newChat": "新对话",
    "tabs.closeTab": "关闭标签页",
  },
};
