...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "updates.dialogTitle": "New momp-web version",
    "updates.current": "Installed momp-web {version}",
    "updates.changelog": "Changelog",
    "updates.viewRelease": "View release",
    "updates.install": "Install update",
    "updates.installing": "Installing…",
    "updates.installed": "momp-web {version} installed. Restart momp-web to finish.",
    "updates.manual": "Run one of these commands to update momp-web:",
