...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "updates.available": "momp update available",
    "updates.availableTitle": "momp {version} is available",
    "updates.dialogEyebrow": "momp release",
    "updates.dialogTitle": "New momp version",
    "updates.current": "Installed momp {version}",
    ...
    "sidebar.copySessionPath": "Copy session file path",
    ...
    "sidebar.deleteProjectFromDisk": "Delete folder from disk",
    "sidebar.deleteProjectFromDiskTitle": "Permanently delete project folder and all files from PC",
    "sidebar.deleteProjectConfirm": "Permanently delete folder {path} and all files from disk?",
    "sidebar.deleteProjectConfirmBtn": "Delete permanently",
    ...
    "directoryPicker.newFolderName": "New folder name",
    ...
    "roles.description": "omp routes work by role, not by one current model. Assign a model to each role and both momp-web and the omp CLI use it.",
    "roles.scope": "Save to",
    ...
    "roles.source.default": "momp default",
    ...
    "chat.thinkingUseDefault": "Use momp default",
    ...
    "chat.voiceListening": "Recording... Click to stop",
    "chat.voiceNotSupported": "Speech recognition is not supported in your browser",
    "chat.voiceError": "Voice input error",
    "chat.voiceNetworkError": "Cloud speech recognition service is unavailable in this browser. Please use Google Chrome or Microsoft Edge for voice input.",
    "chat.voicePermissionError": "Microphone access blocked. Please allow microphone permissions in browser settings.",
    "chat.voiceNoSpeech": "No speech detected. Please try speaking again.",
    "chat.commandRefactor": "Refactor code",
    "chat.commandTests": "Write unit tests",
    "chat.commandReview": "Code review",
    "chat.commandFix": "Fix error / bug",
    "chat.commandExplain": "Explain code",
    "chat.commandDoc": "Code documentation",
    "files.editMode": "Edit",
    "files.save": "Save (Ctrl+S)",
    "files.saving": "Saving...",
    "files.saved": "Saved",
    "files.saveError": "Failed to save file",
    "files.unsavedChanges": "Unsaved changes",
    "files.confirmDiscard": "You have unsaved changes. Discard them?",
    "models.localDiscoveryTitle": "Local Models (Ollama, LM Studio)",
    "models.localDiscoveryScan": "🔍 Scan for Local Models",
    "models.localDiscoveryScanning": "Scanning local services...",
    "models.localDiscoveryFound": "Found: {services}",
    "models.localDiscoveryNotFound": "No local Ollama or LM Studio services found",
    "models.localDiscoveryAdd": "Connect {name} ({count} models)",
    "models.localDiscoveryAdded": "Provider {name} added successfully!",
    "settings.notifications": "Browser Notifications",
    "settings.notificationsDesc": "Send a system notification when the agent completes a response in a background tab.",
    "settings.notificationsEnable": "Enable notifications",
    "settings.notificationsEnabled": "Notifications enabled",
    "settings.notificationsPermissionDenied": "Notification permission is blocked in browser settings",
